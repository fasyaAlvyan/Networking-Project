...
* **Trunk path:** Jalur transmisi data untuk menampung frame dengan tag 802.1Q(VLAN) atau untuk menambahkan tag pada frame, bertukar dan meneruskan frame/packet dengan menggunakan 1 media transmisi saja yang terhubung antar Intermediary Device. (single link untuk multiple VLAN)
...
* **Untagged/native VLAN link:** Jalur khusus transmisi data untuk device Legacy yang tidak support VLAN dengan mengirim data tanpa tagging VLAN pada frame agar device bisa membaca frame yang diterima. (Switch 2 ↔ Ruijie)
...
- Switch 1        : 10.1.99.2
- Switch 2        : 10.1.99.3
- Ruijie Switch 3 : Tidak memiliki IP Management karena pure sebagai switch managed layer 2
