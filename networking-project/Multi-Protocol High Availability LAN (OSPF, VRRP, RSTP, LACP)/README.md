...
##### Pada hasil pengujian menggunakan metode ping, dengan mengirimkan **ICMP echo request** dari client VLAN Engineering dengan IP *10.10.11.3*, terbukti mendapatkan **ICMP echo reply** dari seluruh client pada network, *192.168.100.0/24(Guest2)*,*10.20.1.0/28(Server)*,*192.168.10.0/24(Office)*,*192.168.20.0/24(Guest)*. Bisa disimpulkan jika antar client saling terkoneksi
### 2. 
